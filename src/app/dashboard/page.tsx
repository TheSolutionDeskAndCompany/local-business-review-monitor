      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">Welcome back! Here's what's happening with your reviews.</p>
          </div>
          <Link 
            href="/locations"
            ...
            <div className="px-4 py-5 sm:p-6">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">New Reviews (7d)</dt>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">Rating Trend</dt>
                    <dd className="flex items-baseline">
                      <div className="text-2xl font-semibold text-gray-900">–</div>
                    </dd>
                  </dl>
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
            ...
            <p className="mt-1 max-w-2xl text-sm text-gray-500">Latest customer feedback from all locations.</p>
          </div>
          <div className="bg-white overflow-hidden">
            <div className="px-4 py-5 sm:p-6 text-center">
              ...
              <p className="mt-1 text-sm text-gray-500">Connect a location to start receiving reviews.</p>
              <div className="mt-6">
                <Link
                  href="/locations"
